...
public class WSERLottery
{
    ...
    public static void main(String[] args) {
        WSERLottery lottery = new WSERLottery();
        GatewayServer server = new GatewayServer(lottery);
        server.start();

        // int[] result = runLottery();
        // for(int i = 0; i < 9; i++){
    ...
    public static int[] runLottery(int numTrials) {
        ...
        System.out.println(suEnd-suStart+ " milliseconds");
        System.out.println(simEnd-simStart+ " milliseconds");
        System.out.println(resultTime-simEnd+ " milliseconds");
        System.out.println(finishTime-resultTime+ " milliseconds");
